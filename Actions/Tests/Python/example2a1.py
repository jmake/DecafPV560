...
SEE : 
    https://github.com/tueimage/essential-skills/tree/master
    https://github.com/malaterre/GDCM


"""

##folder = r"F:\z2025_1\Dicom\DicomTestImages5"
##folder = r"F:\z2025_1\Dicom\DicomTestImages2\DICOM_10\Anatomy"
##folder = r"F:\z2025_1\Dicom\DicomTestImages2\DICOM_10\TAP3"
##folder = r"F:\z2025_1\Dicom\DicomTestImages3"

## FROM: https://examples.vtk.org/site/Python/IO/ReadDICOMSeries/
folder = r"F:\z2025_1\Dicom\DicomTestImages1\matlab\examples\sample_data\DICOM\digest_article"

## FROM: https://www.dicomlibrary.com/
##folder = r"F:\z2025_1\Dicom\DicomTestImages4\series-000000"
#folder = r"F:\z2025_1\Dicom\DicomTestImages4\series-000001"
...
def main():
    ...
    skin_extractor.GetOutputPort()

    print( skin_extractor )
