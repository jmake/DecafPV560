...
public : 
	...
	//void CreatePixelTextureDisplay(std::string slideName, APixelTextureDisplay*& actor, AnatomicalProperties result); 	


void CreateAnatomicalBufferAsync(
vtkImageData* domain, 
...
void CuttersRsnaCervicalSpineFractureDetection(); 
