...
//----------------------------------------------------------------------------------|  |--//
UVolumeTexture* CreateVolumeTextureFromFloatData2(int32 Width, int32 Height, int32 tilesX, int32 tilesY, TArrayView<float> Data)
{
	...
	FLinearColor ColorMin = FLinearColor::Red;
...
void AVti2VolumeTexture::BeginPlay()
{
	...
	{ 
		...
		DataTiles(dataTotal, i, dataLocal, widthLocal, heightLocal, widthTotal, heightTotal);
	}

//CreateDataTest(dataTotal, widthTotal, heightTotal); 
//CreateDataTest(dataTotal, widthLocal, heightLocal); 

	UpdateDynamicTexture2D(dynamicTexture, dataTotal);
	SaveDynamicTexture2D(dynamicTexture, dynamicTextureName + "_1.png"); 

//UVolumeTexture* volumeTexture = CreateVolumeTextureFromFloatData1(widthLocal, heightLocal, deepLocal, TArrayView<float>(dataTotal));	
//UVolumeTexture* volumeTexture = CreateVolumeTextureFromFloatData2(widthLocal, heightLocal, deepLocal, TArrayView<float>(dataTotal));	
UVolumeTexture* volumeTexture = CreateVolumeTextureFromFloatData2(widthLocal, heightLocal, tilesX, tilesY, TArrayView<float>(dataTotal));	
