...
void AMyActor1::CreateAxial(float value) 
{
...
void AMyActor1::CreateSourface(float value)
{
	if(vti_ptr == nullptr) return ; 
    ...
    UE_LOG(LogTemp, Warning, TEXT("[CreateSourface] value : %f "), threshold);
} 
