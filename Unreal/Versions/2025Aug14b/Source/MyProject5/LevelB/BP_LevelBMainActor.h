...
public:
	...
	void WidgetCreate(); 
	void BlockBackGroud(UMainWidget* MainWidgetInstance);

    //UPROPERTY() UMainWidget* MainWidgetInstance = nullptr;		

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UI")
    TSubclassOf<UMainWidget> MainWidget = nullptr;

public :
	void LiveRenderLayout(UMainWidget* MainWidgetInstance);  
	void LiveRenderApply(USliderWidget* RadialSliderWidget); 

	APlayerController* playerController = nullptr; 
	TArray<USliderWidget*> SliderWidgets;
