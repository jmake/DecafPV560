...
public:	
    ...
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "SpicyTools")
    ...
    // Exposed material to assign in editor
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "SpicyTools")
    UMaterialInterface* BaseMaterial;

    UPROPERTY(BlueprintReadOnly, Category = "SpicyTools")
    ...
    void GenerateVolumeTexture(UStaticMeshComponent* Mesh);	
