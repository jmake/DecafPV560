...
void VtiTest() 
{
	...
	double anatomicalView[9] = {1, 0, 0, 0, 1, 0, 0, 0, 1};
	...
	double *data = ArrayGet3<double>(pd, key, length); 
	...
	// JULY 29, -> CREATE IMAGE TEXTURE, 
	// SEE : F:\Download\DecafPV560\Omniverse\Versions\2025July24a\Sources\vtktools.py
}
