...
*/
    ...
    bool NifftiLoader::LoadFile(std::string filename, std::string key, bool centered)
    {
    ...
    void CutterManager::VtiSet(void* obj, std::string key)
    {
        ...
        std::cout << "[CutterManager] VtiSet : '" << vti->GetClassName() <<"' \n";
    }
    ...
    )
    {
        ...
        else 
        {
            ...
            if(centered) cutter = CenterAtOrigin(cutter); 
