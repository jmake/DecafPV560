...
public class VertexVisualizer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Measure.ExecutionTime( UpdateMesh , "[UpdateMesh]");
        //UpdateMesh();
    ...
    public void MeasureExecutionTime(Action action, string label = "Execution Time")
    {
        Stopwatch stopwatch = Stopwatch.StartNew();
        action();
        stopwatch.Stop();

        UnityEngine.Debug.Log($"{label}: {stopwatch.ElapsedMilliseconds} ms");
    }
