...
public:
  ...
  int Initialize(int outputFrequency, std::string& fileName) {return 0;};

  int RequestDataDescription(vtkCPDataDescription* dataDescription) {return 0;};

  int CoProcess(vtkCPDataDescription* dataDescription) {return 0;};
...
int main(int argc, char* argv[])
{
  ...
  vtkCPVTKPipeline* pipeline = vtkCPVTKPipeline::New();

  // read the coprocessing python file
  if(pipeline->Initialize(-1, cpPythonFile) == 0)
    {
